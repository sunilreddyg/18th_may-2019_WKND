...
public class String_Comparision_Commands 
{
	...
	public static void main(String[] args) 
	{
		...
		/*
		 * String:-->
		 * 			=> String is a not only datatype and also called as class.
		 * 			Because string contain set of events to validate store characters.
		 */
		...
		/*
		 * EqualIgnorecase:-->
		 * 			Method verify equal Comparision between two string by ignore
		...
		System.out.println("mobile number in number of charcters are => "+len);
